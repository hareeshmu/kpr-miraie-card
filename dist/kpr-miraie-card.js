          ...
          <div class="card-header">
            ...
            <div class="card-meta">
              ...
              <div class="more-wrap">
                ...
                ${this._showMoreMenu?t`
                  <div class="more-backdrop" @click=${()=>{this._showMoreMenu=!1}}></div>
        ...
        ${!c&&this._expandFeatures&&this.config.show_extras?t`
          ...
          <div class="detail-popup" @click=${e=>e.stopPropagation()}>
            ...
            <div class="toggle-row">
              ${g?t`<button class="toggle-btn ${"on"===g.state?"active":""}" @click=${()=>this._toggleSwitch(this.config.eco_entity)}><ha-icon icon="mdi:leaf"></ha-icon><span>Eco</span></button>`:""}
